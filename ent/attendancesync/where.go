...
func ID(id string) predicate.AttendanceSync {
	return predicate.AttendanceSync(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}

// IDEQ applies the EQ predicate on the ID field.
func IDEQ(id string) predicate.AttendanceSync {
	return predicate.AttendanceSync(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id string) predicate.AttendanceSync {
	return predicate.AttendanceSync(func(s *sql.Selector) {
...
func IDIn(ids ...string) predicate.AttendanceSync {
	return predicate.AttendanceSync(func(s *sql.Selector) {
...
func IDNotIn(ids ...string) predicate.AttendanceSync {
	return predicate.AttendanceSync(func(s *sql.Selector) {
		v := make([]interface{}, len(ids))
		for i := range v {
			v[i] = ids[i]
...
func IDGT(id string) predicate.AttendanceSync {
	return predicate.AttendanceSync(func(s *sql.Selector) {
...
func IDGTE(id string) predicate.AttendanceSync {
	return predicate.AttendanceSync(func(s *sql.Selector) {
...
func IDLT(id string) predicate.AttendanceSync {
	return predicate.AttendanceSync(func(s *sql.Selector) {
...
func IDLTE(id string) predicate.AttendanceSync {
	return predicate.AttendanceSync(func(s *sql.Selector) {
...
func LastSyncID(v string) predicate.AttendanceSync {
	return predicate.AttendanceSync(func(s *sql.Selector) {
...
func LastSyncIDEQ(v string) predicate.AttendanceSync {
	return predicate.AttendanceSync(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldLastSyncID), v))
	})
}
...
func LastSyncIDNEQ(v string) predicate.AttendanceSync {
	return predicate.AttendanceSync(func(s *sql.Selector) {
...
func LastSyncIDIn(vs ...string) predicate.AttendanceSync {
...
func LastSyncIDNotIn(vs ...string) predicate.AttendanceSync {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func LastSyncIDGT(v string) predicate.AttendanceSync {
	return predicate.AttendanceSync(func(s *sql.Selector) {
...
func LastSyncIDGTE(v string) predicate.AttendanceSync {
	return predicate.AttendanceSync(func(s *sql.Selector) {
...
func LastSyncIDLT(v string) predicate.AttendanceSync {
	return predicate.AttendanceSync(func(s *sql.Selector) {
...
func LastSyncIDLTE(v string) predicate.AttendanceSync {
	return predicate.AttendanceSync(func(s *sql.Selector) {
...
func LastSyncIDContains(v string) predicate.AttendanceSync {
	return predicate.AttendanceSync(func(s *sql.Selector) {
...
func LastSyncIDHasPrefix(v string) predicate.AttendanceSync {
	return predicate.AttendanceSync(func(s *sql.Selector) {
...
func LastSyncIDHasSuffix(v string) predicate.AttendanceSync {
	return predicate.AttendanceSync(func(s *sql.Selector) {
...
func LastSyncIDEqualFold(v string) predicate.AttendanceSync {
	return predicate.AttendanceSync(func(s *sql.Selector) {
...
func LastSyncIDContainsFold(v string) predicate.AttendanceSync {
	return predicate.AttendanceSync(func(s *sql.Selector) {
...
func HasAttendanceDay() predicate.AttendanceSync {
	return predicate.AttendanceSync(func(s *sql.Selector) {
...
func HasAttendanceDayWith(preds ...predicate.AttendanceDay) predicate.AttendanceSync {
	return predicate.AttendanceSync(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func And(predicates ...predicate.AttendanceSync) predicate.AttendanceSync {
	return predicate.AttendanceSync(func(s *sql.Selector) {
		s1 := s.Clone().SetP(nil)
...
func Or(predicates ...predicate.AttendanceSync) predicate.AttendanceSync {
	return predicate.AttendanceSync(func(s *sql.Selector) {
		s1 := s.Clone().SetP(nil)
...
func Not(p predicate.AttendanceSync) predicate.AttendanceSync {
	return predicate.AttendanceSync(func(s *sql.Selector) {
		p(s.Not())
	})
}
